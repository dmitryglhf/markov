...
use crate::session::editor::{launch_editor, resolve_editor_or_default};
use anyhow::{Context, Result};
use console::{measure_text_width, style};
use goose::custom_requests::{SourceEntry, SourceType};
use goose::skills::{
    discover_all_skills, global_skills_dir, list_installed_skills, project_skills_dir,
    skill_argument_hint, skill_name_problem,
};
